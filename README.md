# Logistic Regression Classifier in TensorFlow (CPU) with Shapley Explanations
## Project Description
...
- A **Logistic Regression** classifier built using **TensorFlow**. The model runs on CPU.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Logistic Regression classifier model implemented using TensorFlow.
